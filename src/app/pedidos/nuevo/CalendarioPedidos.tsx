    ...
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-orange-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        <div className="bg-white rounded-xl shadow-md p-6">
          <h2 className="text-xl font-bold text-gray-800 mb-4">📅 Seleccioná las fechas</h2>
          ...
          <div className="bg-white rounded-xl shadow-md p-6">
            ...
            <div className="space-y-4">
              {fechasDelPlan.map((fecha) => {
                ...
                return (
                  <div key={fechaStr} className="border border-gray-200 rounded-lg p-4">
                          ...
                          <button
                            ...
                            className={`p-3 rounded-lg text-left transition-all ${
                              item
                                ...
                                : 'bg-gray-50 border-2 border-dashed border-gray-300 hover:border-amber-500'
                            }`}
                          >
                            <p className="text-xs font-semibold text-gray-600 mb-1">{tipoLabel}</p>
                            {item ? (
                              <>
                                <p className="text-sm font-bold text-gray-800">{item.plato.nombre}</p>
