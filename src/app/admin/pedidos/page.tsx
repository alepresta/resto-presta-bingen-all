      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          <div className="bg-white rounded-xl shadow-md p-4 border-l-4 border-blue-500">
            <p className="text-xs text-gray-600 font-semibold">TOTAL PEDIDOS</p>
          ...
          <div className="bg-white rounded-xl shadow-md p-4 border-l-4 border-red-500">
            <p className="text-xs text-gray-600 font-semibold">CANCELADOS</p>
            <p className="text-2xl font-bold">
        ...
        {(!grupos || grupos.length === 0) && (
          <div className="bg-white rounded-xl shadow-md p-12 text-center">
            <p className="text-gray-500 text-lg mb-4">No hay pedidos creados aún</p>
            <Link
              href="/admin/pedidos/grupos/nuevo"
