        ...
        <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
          ...
          {seccionActiva === 'basico' && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-700 dark:text-gray-200 mb-2">Parte Util</label>
          ...
          {seccionActiva === 'vitaminas' && (
            <div className="space-y-6">
              ...
              <h3 className="font-semibold text-gray-700 dark:text-gray-200 mt-4">Hidrosolubles - Complejo B</h3>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
